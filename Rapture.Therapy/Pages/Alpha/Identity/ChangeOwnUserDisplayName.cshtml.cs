...
{
    public class ChangeOwnUserDisplayNameModel : BasePageModel
    {
        ...
        public ChangeOwnUserDisplayNameModel(ILogger<ChangeOwnUserDisplayNameModel> logger, IConfiguration configuration, IUserSession userSession, IEadentUserIdentity eadentUserIdentity) : base(logger, configuration, userSession, eadentUserIdentity)
        {
        }
